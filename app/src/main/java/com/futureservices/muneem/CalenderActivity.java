        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (expenseTypeSelected && globals.getExpenseCapacity() > 0) {
                    ...
                    Toast.makeText(CalenderActivity.this, "please select Expense type", Toast.LENGTH_SHORT).show();
                    else
                        Toast.makeText(CalenderActivity.this, "please add Money Status", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
