...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<ModelMilkRecord> GetSavedMilkRecord(String Date) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                mmr.setMilkQuantity(cursor.getDouble(2));
                mmr.setMilkRate(cursor.getDouble(3));
                listMMR.add(mmr);
