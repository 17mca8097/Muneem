package com.futureservices.muneem.Globals;
...
public class GlobalVariables {
    ...
    public GlobalVariables(Double cashAvailable, Double accountAvailable, String dateOfExpense, String currentDate, String memo, boolean isNewUser, Double totalMoneyAdded, Double totalExpense, String reasonAccount, Double expenseCapacity, Double milkRate, boolean firstTime, String reasoncash) {
